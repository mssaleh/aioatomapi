...
from aioatomapi.api_pb2 import ConnectResponse, HelloResponse
from aioatomapi.connection import APIConnection, ConnectionParams
from aioatomapi.core import APIConnectionError
from aioatomapi.host_resolver import AddrInfo, IPv4Sockaddr
...
@pytest.fixture
def resolve_host():
    with patch("aioatomapi.host_resolver.async_resolve_host") as func:
